...
const platformLabels: Record<string, string> = {
  ...
  x: "X / Twitter",
  apify_x: "X / Twitter",
  apify_twitter: "X / Twitter",
  discord: "Discord",
  discord_server: "Discord Server",
  apify_discord: "Discord",
  tiktok: "TikTok",
  apify_tiktok: "TikTok",
  instagram: "Instagram",
  ...
  apify_facebook_group: "Facebook Groups",
  apify_facebook_groups: "Facebook Groups",
  vr_forum: "VR Forums",
  vr_forums: "VR Forums",
  vr_blog: "VR Blogs",
  blogs: "VR Blogs",
  ...
  profile_lead: "Profile Leads",
  server_discovery: "Servers"
};
...
const valueLabels: Record<string, string> = {
  ...
  creator_opportunity: "Creator Prospect",
  ...
  apify_conversations: "Apify Conversations",
  forums: "VR Forums",
